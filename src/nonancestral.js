...
const Nonancestral = () => {
    ...
    const ancestr = [
        createData('YAAU or YAO - Vitellaria paradoxa', 'YES', 'YES', 'Significant role in soil and water conservation and environmental protection. Seed husks are an excellent mulch and fertiliser. Furthermore, they can remove heavy metal ions in aqueous solutions. Cooperative plants with cereal crops', 'The kernel of the seed contains a vegetable fat known as shea butter. Refined fat is marketed as margarine and baking fat. The reddish latex which exudes from deep cuts in the bark is used as a chewing gum. The flowers are edible and sometimes made into fritters. High unsaponifiable matter content imparts excellent moisturizing characteristics. Suitable for making candles. As waterproofing material is used as daubing for earthen walls, doors and windows. Waste water from shea butter production has pesticidal properties. Only unproductive and unhealthy trees are cut for timber. Leaves, ground  roots, barks are used in medicine'),
        createData('KALARUFU - Grevillea robusta', 'YES', 'NO', 'Windbreak, provides fodder for the animals, used for soil conservation, shade (formerly know as a shade tree for tea and coffee)', 'Wood is used for paneling, joinery, cabinet making. Provide poles. Provide firewood and charcoal'),
